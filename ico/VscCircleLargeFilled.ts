...
/**
 * CircleLargeFilled icon from VS Code Icons
 * @module
 */
export function VscCircleLargeFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default VscCircleLargeFilled;
