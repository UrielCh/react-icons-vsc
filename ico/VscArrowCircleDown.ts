...
/**
 * ArrowCircleDown icon from VS Code Icons
 * @module
 */
export function VscArrowCircleDown(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default VscArrowCircleDown;
