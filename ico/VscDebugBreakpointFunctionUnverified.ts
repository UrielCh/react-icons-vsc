...
/**
 * DebugBreakpointFunctionUnverified icon from VS Code Icons
 * @module
 */
export function VscDebugBreakpointFunctionUnverified(props: IconBaseProps): VNode<JSX.SVGAttributes> {
