...
/**
 * FileSymlinkDirectory icon from VS Code Icons
 * @module
 */
export function VscFileSymlinkDirectory(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default VscFileSymlinkDirectory;
