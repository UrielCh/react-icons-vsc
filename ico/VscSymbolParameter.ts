...
/**
 * SymbolParameter icon from VS Code Icons
 * @module
 */
export function VscSymbolParameter(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default VscSymbolParameter;
