...
/**
 * ArrowCircleLeft icon from VS Code Icons
 * @module
 */
export function VscArrowCircleLeft(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default VscArrowCircleLeft;
