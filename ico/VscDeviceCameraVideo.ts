...
/**
 * DeviceCameraVideo icon from VS Code Icons
 * @module
 */
export function VscDeviceCameraVideo(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default VscDeviceCameraVideo;
