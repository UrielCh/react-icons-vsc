...
/**
 * TypeHierarchySub icon from VS Code Icons
 * @module
 */
export function VscTypeHierarchySub(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default VscTypeHierarchySub;
