...
/**
 * LayoutSidebarLeftOff icon from VS Code Icons
 * @module
 */
export function VscLayoutSidebarLeftOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default VscLayoutSidebarLeftOff;
