...
/**
 * CommentDiscussion icon from VS Code Icons
 * @module
 */
export function VscCommentDiscussion(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default VscCommentDiscussion;
