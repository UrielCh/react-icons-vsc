...
/**
 * LayoutPanelCenter icon from VS Code Icons
 * @module
 */
export function VscLayoutPanelCenter(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default VscLayoutPanelCenter;
