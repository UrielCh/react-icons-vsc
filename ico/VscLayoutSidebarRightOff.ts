...
/**
 * LayoutSidebarRightOff icon from VS Code Icons
 * @module
 */
export function VscLayoutSidebarRightOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default VscLayoutSidebarRightOff;
