...
/**
 * UngroupByRefType icon from VS Code Icons
 * @module
 */
export function VscUngroupByRefType(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default VscUngroupByRefType;
