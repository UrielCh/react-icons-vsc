...
/**
 * ActivateBreakpoints icon from VS Code Icons
 * @module
 */
export function VscActivateBreakpoints(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default VscActivateBreakpoints;
