...
/**
 * DesktopDownload icon from VS Code Icons
 * @module
 */
export function VscDesktopDownload(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default VscDesktopDownload;
