...
/**
 * ArrowCircleRight icon from VS Code Icons
 * @module
 */
export function VscArrowCircleRight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default VscArrowCircleRight;
