...
/**
 * GitPullRequestCreate icon from VS Code Icons
 * @module
 */
export function VscGitPullRequestCreate(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default VscGitPullRequestCreate;
