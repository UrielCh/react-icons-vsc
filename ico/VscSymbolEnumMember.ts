...
/**
 * SymbolEnumMember icon from VS Code Icons
 * @module
 */
export function VscSymbolEnumMember(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default VscSymbolEnumMember;
