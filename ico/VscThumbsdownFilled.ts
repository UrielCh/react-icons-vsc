...
/**
 * ThumbsdownFilled icon from VS Code Icons
 * @module
 */
export function VscThumbsdownFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default VscThumbsdownFilled;
