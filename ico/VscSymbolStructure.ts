...
/**
 * SymbolStructure icon from VS Code Icons
 * @module
 */
export function VscSymbolStructure(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default VscSymbolStructure;
