...
/**
 * LayoutSidebarLeft icon from VS Code Icons
 * @module
 */
export function VscLayoutSidebarLeft(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default VscLayoutSidebarLeft;
