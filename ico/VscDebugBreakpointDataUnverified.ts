...
/**
 * DebugBreakpointDataUnverified icon from VS Code Icons
 * @module
 */
export function VscDebugBreakpointDataUnverified(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default VscDebugBreakpointDataUnverified;
