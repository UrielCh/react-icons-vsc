...
/**
 * DebugDisconnect icon from VS Code Icons
 * @module
 */
export function VscDebugDisconnect(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default VscDebugDisconnect;
