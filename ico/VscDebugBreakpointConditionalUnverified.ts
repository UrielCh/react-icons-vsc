...
/**
 * DebugBreakpointConditionalUnverified icon from VS Code Icons
 * @module
 */
export function VscDebugBreakpointConditionalUnverified(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default VscDebugBreakpointConditionalUnverified;
